...
<div class="sidebar">
    <ul>
        <li>
            <a href="{{ route('employer.dashboard') }}"><i class="bi bi-briefcase"></i> Job Posts</a>
        </li>
        <li>
            <a href="{{ route('employer.applications') }}"><i class="bi bi-newspaper"></i> Applications</a>
        </li>
        <li>
            <a href="{{ route('employer.profile') }}"><i class="bi bi-person"></i> Profile</a>
        </li>
        <li>
            <a href="{{ route('employer.settings') }}"><i class="bi bi-gear"></i> Settings</a>
        </li>
        <br>
        <br>
        <br>
